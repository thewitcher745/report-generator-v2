...
class BitgetReport(Report):
    ...
    def draw_details(
        self, signal_type, leverage, gen_date: datetime.datetime, username
    ):
    ...
    def draw_leverage(self, leverage):
        ...
        xy = (
            leverage_styling.position.x * self.image.size[0],
            leverage_styling.position.y * self.image.size[1],
        )
