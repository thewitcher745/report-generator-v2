...
styling_dict = {
    "binance_1": {
        ...
        "signal_type": ElementStyling(position=Position(0.116, 0.285), font="./fonts/BinancePlex.otf", font_size=22,
                                      short_color="#b6536c", long_color="#438A70"),
    ...
    "bitget_4": {
        ...
        "signal_type": ElementStyling(position=Position(0.072, 0.448), font="./fonts/Araboto Normal 400.ttf", font_size=38, margin_x=10,
                                      margin_y=12,
                                      margin_y_mult=0.7,
                                      short_color="#ff474d",
                                      long_color="#299bb6"),
    ...
    "bitget_5": {
        "symbol": ElementStyling(position=Position(0.059, 0.348), font="./fonts/Switzer-Semibold.otf", font_size=50.5, color="white"),
        "signal_type": ElementStyling(position=Position(0.059, 0.419), font="./fonts/Switzer-Medium.otf", font_size=34, margin_x=10,
                                      margin_y=12,
                                      margin_y_mult=0.7,
                                      short_color="#ff474d",
                                      long_color="#299bb6"),
        "leverage": ElementStyling(position=Position(0.219, 0.419), font="./fonts/Switzer-Semibold.otf", font_size=34, color="#8c8c8c"),
        "roi": ElementStyling(position=Position(0.059, 0.49), font="./fonts/Switzer-Semibold.otf", font_size=68, color="#299bb6"),
        "entry": ElementStyling(position=Position(0.381, 0.605), font="./fonts/Switzer-Semibold.otf", font_size=34, color="white"),
        "target": ElementStyling(position=Position(0.381, 0.666), font="./fonts/Switzer-Semibold.otf", font_size=34, color="white"),
        "gen_date": ElementStyling(position=Position(0.267, 0.098), font="./fonts/Switzer-Regular.otf", font_size=32, color="#8c8c8c"),
        "referral": ElementStyling(position=Position(0.292, 0.865), font="./fonts/Switzer-Semibold.otf", font_size=28, color="black"),
        "qr_code": ElementStyling(position=Position(0.772, 0.857), size=129),
        "username": ElementStyling(position=Position(0.251, 0.196), font="./fonts/Switzer-Semibold.otf", font_size=39, color="white"),
        "username_id": ElementStyling(position=Position(0.251, 0.251), font="./fonts/Switzer-Medium.otf", font_size=30.5,
                                      color='#8c8c8c'),
        "draw_qr_referral": True,
        "draw_datetime": True,
        "draw_username": True
