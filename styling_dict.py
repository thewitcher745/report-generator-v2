class ElementStyling:
    def __init__(self, position, font="arial.ttf", font_size=12, color=(255, 255, 255), size=150):
...
styling_dict = {
    ...
    "bybit_1": {
        "symbol": ElementStyling(position=Position(0.045, 0.2), font="./fonts/IBMPlexSans-SemiBold.ttf", font_size=60,
                                 color=(255, 255, 255)),
