...
styling_dict = {
    ...
    "bitget_3": {
        "symbol": ElementStyling(position=Position(0.035, 0.072), font="./fonts/Araboto Bold 400.ttf", font_size=20,
                                 color=(255, 255, 255)),
        "signal_type": ElementStyling(position=Position(0.035, 0.155), font="./fonts/Araboto Normal 400.ttf",
                                      font_size=12,
                                      margin_x=10,
                                      margin_y=12,
                                      margin_y_mult=0.7,
                                      color=(255, 255, 255)),
        "leverage": ElementStyling(position=Position(0.116, 0.157), font="./fonts/kommon-grotesk-bold.otf", font_size=14,
                                   color=(255, 255, 255)),
        "roi": ElementStyling(position=Position(0.035, 0.32), font="./fonts/Araboto Normal 400.ttf", font_size=49,
                              color="#23b3aa"),
        "entry": ElementStyling(position=Position(0.18, 0.48), font="./fonts/Araboto Bold 400.ttf", font_size=12,
                                color=(110, 85, 251)),
        "target": ElementStyling(position=Position(0.18, 0.553), font="./fonts/Araboto Bold 400.ttf", font_size=12,
                                 color=(110, 85, 251)),
        "gen_date": ElementStyling(position=Position(0.165, 0.653), font="./fonts/Araboto Normal 400.ttf", font_size=12,
                                   color=(101, 102, 120)),
        "referral": ElementStyling(position=Position(0.17, 0.84), font="./fonts/Araboto Bold 400.ttf",
                                   font_size=20,
                                   color="white"),
